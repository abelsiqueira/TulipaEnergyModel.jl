...
@testitem "Simple Arithmetic" tags=[:basic, :testing] begin
    @test 1 + 1 == 2
    @test 2 * 3 == 6
    @test 10 / 2 == 5.0
end

@testitem "TulipaEnergyModel Module" tags=[:basic, :module] begin
...
@testitem "Variable Operations" tags=[:basic, :math] begin
    x = 5
    y = 3
    @test x + y == 8
    @test x * y == 15
